...
export default function Home() {
  const [messages, setMessages] = useState([{
    role: 'assistant',
    content: `Hello! I'm your customer support assistant for PCTRONICS. How can I help you today?`
  }]);
        ...
        >
          ...
          >
            <Box display="flex" alignItems="center">
              <Avatar sx={{ bgcolor: '#e0e0e0', color: '#000' }}>PC</Avatar>
              <Box ml={2}>
                <Typography variant="subtitle1" fontWeight="bold">PCTRONICS BOT</Typography>
                <Typography variant="body2" color="textSecondary">Making your tech decisions easier.</Typography>
              </Box>
            </Box>
          </Box>
          <Stack 
